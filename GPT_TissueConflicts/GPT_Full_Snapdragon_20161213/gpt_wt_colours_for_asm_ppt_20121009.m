function m = gpt_wt_colours_for_asm_ppt_20121009( m )
%m = gpt_wt_colours_for_asm_ppt_20121009( m )
%   Morphogen interaction function.
%   Written at 2013-02-03 17:48:04.
...
%%% USER CODE: INITIALISATION
    ...
    if m.globalDynamicProps.currentIter==0 % the first iteration
        ...
        %****************************** CHANGE THIS INDEX ******************************
        m.userdata.ranges.modelnumber.index=9; % selects one of these submodels, 
